...
export const BlogBody: React.FC<BlogBodyProps> = ({ body, tags }) => {
  ...
  return (
    <article className="bg-surface-lowest p-3 ring-1 ring-outline-variant/20 sm:p-5 lg:p-6">
      ...
      <div className="bg-surface p-3 ring-1 ring-outline-variant/20 sm:p-5 lg:p-6">
